...
;(function() {
   ...
   * @param lookupTable
   */
  exports.config = function(lookupTable, addressLookupTable) {
    this.extLookupTable = lookupTable;
    this.extAddressLookupTable = addressLookupTable;
  }.bind(this);
  ...
  this.init = function() {
    ...
    this.addressLookupTable = this.extAddressLookupTable || [
      'street_address',
      'street_number',
      'route',
      'premise',
    ...
    this.lookupTable = this.extLookupTable || {
      country: [
        'country'
      ],
      city: [
